...
const PELLIKODUKU_ADDRESS = resolveOptionalAddress(process.env.PELLIKODUKU_ADDRESS);
const PELLIKODUKU_MAP_URL = resolveMapUrl(process.env.PELLIKODUKU_MAP_URL, '');
