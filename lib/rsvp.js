...
const FAMILY_SIDES = {
  akhila: {
    ...
    pelliVenue: process.env.AKHILA_SIDE_ADDRESS || process.env.PELLIKUTHURU_ADDRESS || 'Akhila side address to be confirmed'
  },
  akshay: {
    label: "Akshay's side",
    person: 'Akshay',
    ...
    pelliVenue: process.env.AKSHAY_SIDE_ADDRESS || process.env.PELLIKODUKU_ADDRESS || 'Akshay side address to be confirmed'
  }
};
